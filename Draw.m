function Draw(numObj,costOld,Archive,testPro,Iteration,maxIter,pf,metric,divImp)
%***************************** Draw ************************************   
%% Function: Draw()
%
% ----------------------------  Function   ---------------------------------
...
%       costOld:        function values of new grey wolves
%       costOpt:        function values of first rank level    
